#earthmoon.py
#Here's an example of a system that will run using the Body and System Classes
...
start_graphics(main, title = "Earth-moon simulation",
               width = WINDOW_WIDTH, height = WINDOW_HEIGHT, framerate = FRAME_RATE)
